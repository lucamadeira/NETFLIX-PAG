<script>
  ...
  function selectLanguage(language) {document.querySelector('.lang-text').innerText = language};
  ...
  if (!wrapper.contains(e.target)) {document.getElementById('lang-dropdown').style.display = 'none'};
    }
  });
</script>;
